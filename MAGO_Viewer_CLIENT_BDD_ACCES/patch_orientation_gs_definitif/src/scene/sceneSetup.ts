...
export function createSceneContext(canvas: HTMLCanvasElement): SceneContext {
  ...
  // Babylon fonctionne naturellement en repère main gauche.
  // Ne pas forcer useRightHandedSystem ici : avec les Gaussian Splats Babylon,
  // cela inverse gauche/droite dans la scène client/éditeur.
  ...
  camera.wheelDeltaPercentage = 0.012; // ajusté par le slider Vitesse zoom
  camera.pinchDeltaPercentage = 0.012; // ajusté par le slider Vitesse zoom
  camera.minZ = 0.001;
  camera.maxZ = 100000;
